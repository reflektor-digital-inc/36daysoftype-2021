  ...
  export default {
    ...
    data() {
      return {
        ...
        accSpd : 0.000001 + Math.random() / 100000,
        acc : 0,
        hspd : 0,
        maxHspd : Math.random() * 0.05 + 0.01,
    ...
    mounted() {
      ...
      this.$refs.quad.material.transparent = 1;
    ...
    beforeUnmount() {
      ...
      this.$refs.quad.mesh.removeEventListener('bump', this.bumpLetter);
    ...
    methods : {
      ...
      setRenderTargetSize() {
        ...
        if (this.rtCamera) {
          ...
          this.rtCamera.position.z = (this.letterBumpLerped + 1.5) / aspect;
